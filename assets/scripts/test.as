...
void main() {
    plane pl(glm::vec3(0), glm::quat(glm::radians(0), glm::vec3(1, 0, 0)), glm::vec3(1));
    ...
    //light l2(glm::vec3(10.f, 4.f, -2.f), glm::vec3(0.f, 0.3f, 1.0f), 20);
    ...
    anim.play_ani("walk");
    anim.blend_ani("run");
    directional_light dl(glm::vec3(-1, -1, -1), glm::vec3(1), 1);
