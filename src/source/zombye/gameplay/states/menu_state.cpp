...
void zombye::menu_state::enter() {
    ...
    auto& light = em.emplace("point_light", glm::vec3{2.f, 2.f, -2.f},
        glm::quat{0.f, 0.f , 0.f , 1.f}, glm::vec3{1.f});
    auto& light2 = em.emplace("point_light", glm::vec3{-2.f, 2.f, -2.f},
        glm::quat{0.f, 0.f , 0.f , 1.f}, glm::vec3{1.f});
    light2.component<light_component>()->set_color(glm::vec3{3.f, 0.0f, 2.0f});
